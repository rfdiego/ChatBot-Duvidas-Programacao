...
namespace Microsoft.BotBuilderSamples.Dialog
{
    ...
    public class QnAMakerBaseDialog : QnAMakerDialog
    {
        ...
        public const string DefaultNoAnswer = "Desculpe, nenhum tópico encontrado :(";
        public const string DefaultCardTitle = "Você quis dizer:";
        public const string DefaultCardNoMatchText = "Nenhuma das opções acima.";
        public const string DefaultCardNoMatchResponse = "Obrigado pele feedback.";
